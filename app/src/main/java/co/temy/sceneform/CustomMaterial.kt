...
class CustomMaterial private constructor(
    ...
    class Builder(val context: Context) {
        ...
        fun build(): CompletableFuture<CustomMaterial> {
            ...
            val defaultColorFuture = createTexture(R.raw.diffuse, Texture.Usage.COLOR)
            val defaultMetallicFuture = createTexture(R.raw.roughness, Texture.Usage.DATA)
            val defaultRoughnessFuture = createTexture(R.raw.roughness, Texture.Usage.DATA)
            val defaultNormalFuture = createTexture(R.raw.normal, Texture.Usage.NORMAL)
